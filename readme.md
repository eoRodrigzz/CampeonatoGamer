...
Nossa turma vai organizar partidas de jogos. Queremos registrar **jogo**, **time A**, **time B**, **placar** e **status**. Uma agenda começa `agendada` com placar `0 X 0`. Depois podemos atuaizar o resultafo para `finalizada`.
